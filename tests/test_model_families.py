...
def test_projector_status_finds_model_specific_bf16_on_disk(tmp_path):
...
def test_projector_status_ignores_stale_generic_bf16_for_wrong_model(tmp_path):
...
def test_projector_status_gemma4_finds_model_specific_on_disk(tmp_path):
